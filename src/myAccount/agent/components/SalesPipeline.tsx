      ...
      <div className="hidden md:block">
        <div className="relative flex items-center justify-between">
          ...
          <div
            ...
            style={{
              width: `${((currentStage - 1) / (pipelineStages.length - 1)) * 100}%`,
            }}
          />
            ...
            >
              <div
                className={cn(
                  ...
                  interactive &&
                    stage.id <= currentStage &&
                    "hover:shadow-xl hover:shadow-champagne-gold/40"
                )}
              >
                {stage.id < currentStage ? (
            ...
            <div key={stage.id} className="flex items-center snap-center">
              <button
                ...
                className={cn(
                  ...
                  interactive &&
                    "cursor-pointer active:scale-95 focus:outline-none focus:ring-2 focus:ring-champagne-gold/50"
                )}
              >
                {stage.id < currentStage ? (
