...
type AuthStep = "options" | "email" | "verify" | "success";
        ...
        <div className="mt-6 space-y-4">
          {step === "options" && (
            <>
              ...
              <Button
                variant="outline"
                className="w-full h-14 border-border/50 hover:bg-muted/30 hover:border-champagne-gold transition-all group"
              ...
              >
                <div className="flex items-center justify-center gap-3 w-full">
                  ...
                  <span className="text-foreground font-medium">Email / Token</span>
                </div>
              </Button>
            </>
          )}
