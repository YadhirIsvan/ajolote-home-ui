...
import {
  Home, Camera, Handshake, Award, ImageIcon, EyeOff,
  UserCheck, ArrowRight, Play, X,
} from "lucide-react";
...
const STEPS = [
  { icon: Home,      title: "Registra tu propiedad",  description: "Formulario rápido de 2 minutos. Sin documentos pesados al inicio." },
  { icon: Camera,    title: "Marketing de Élite",       description: "Fotografía profesional y exposición ante compradores verificados." },
  { icon: Handshake, title: "Cierre Seguro",            description: "Negociación experta y acompañamiento legal hasta la firma." },
];
...
const FAQS = [
  { question: "¿Tiene costo publicar?",       answer: "Absolutamente ninguno. Solo ganamos cuando tú ganas." },
  { question: "¿Cuánto tiempo toma?",          answer: "Nuestra estrategia de marketing premium acelera el proceso significativamente." },
  { question: "¿Necesito exclusividad?",       answer: "Ofrecemos contratos flexibles adaptados a tus necesidades." },
];
